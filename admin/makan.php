...
if (isset($_POST["simpan"])) {
  if (tambahMkn($_POST) > 0) {
    echo "<script>
          ...
          window.location.href = 'makan.php'; 
          </script>";
  } else {
    echo "<script>
...
if (isset($_POST["edit"])) {
  if (editMkn($_POST) > 0) {
    echo "<script>
          ...
          window.location.href = 'makan.php'; // Merefresh halaman ke admin.php
          </script>";
  } else {
    echo "<script>
          alert('Gagal Di Ubah');
      ...
      <div class="col-10 p-5" id="bg">
        ...
        <main class="table">
          <section class="table__header mt-5">
            <h1 style="margin-left:10px;">Data Makananan</h1>
                ...
                <?php foreach ($makanan as $row) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="./controller/hapusMkn.php?id=<?= $row["idmakanan"]; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
