                ...
                <ul class="menu-links">
                    ...
                    <ul class="collapse " id="sidemenu2" data-bs-parent="#menu">
                        <li class="nav-link drop">
                            <a class="nav-text text-white" href="admin.php?page=mejapesan">Meja &nbsp;</a>
                        </li>
                        <li class="nav-link drop">
                            <a class=" nav-text text-white" href="admin.php?page=makanpesan">Makanan & Minuman &nbsp; </a>
                        </li>
                    </ul>
                    ...
                    <ul class="collapse " id="sidemenu" data-bs-parent="#menu">
                        <li class="nav-link drop">
                            <a class="nav-text text-white" href="admin.php?page=meja">Meja</a>
                        </li>
                        <li class="nav-link drop">
                            <a class=" nav-text text-white" href="admin.php?page=makan">Makanan & Minuman</a>
                        </li>
                    </ul>
                    <li class="nav-link">
                        <a href="admin.php?page=pengeluaran">
